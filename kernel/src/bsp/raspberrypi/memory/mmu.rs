...
pub type KernelVirtAddrSpace = AddressSpace<{ memory_map::END_INCLUSIVE + 1 }>;

/// Backwards-compatible name used by the initial MMU driver.
pub type KernelAddrSpace = KernelVirtAddrSpace;
