...
impl fmt::Write for PL011Uart {
    fn write_str(&mut self, s: &str) -> fmt::Result {
        console::interface::RawWrite::write_str(self, s);
        Ok(())
    }
}

impl console::interface::RawWrite for PL011Uart {
...
impl console::interface::RawRead for PL011Uart {
...
impl console::interface::RawConsole for PL011Uart {}
